...
from PyQt5.QtWidgets import QSizePolicy, QFrame, QGroupBox, QHBoxLayout, QGridLayout, QVBoxLayout, QLayout, QAction, QMessageBox
import PyQt5.QtWidgets
from PyQt5.QtWidgets import QPushButton, QLabel, QMainWindow, QWidget
...
class DrawabaleTetrisBoard(PyQt5.QtWidgets.QWidget):
    """A base class for tetris board widgets that can draw themselves."""
...
GameState = myEnum('running', 'paused', 'gameover')
